...
from modules.embeddings.schemas.embedding_schema import EmbeddingCreate, EmbeddingRead
...
def update_embedding(embedding_id: int, embed_data: EmbeddingCreate, db: Session = Depends(get_db), current_vendor: Vendor = Depends(get_current_vendor)):
